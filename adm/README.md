...
1. On the last trading day of each month, calculate the "momentum score" for the S&P 500 (VOO) and the international small cap equities (SCZ). The momentum score is the average of the 1, 3, and 6-month total return for each asset.
2. If the momentum score of SCZ > VOO and is greater than 0, invest in SCZ.
3. If the momentum score of VOO > SCZ and is greater than 0, invest in VOO.
4. If neither momentum score is greater than 0, invest in long-term US Treasuries (TLT)

## Assets Typically Held

| Ticker | Name                            | Sector                           |
| ------ | ------------------------------- | -------------------------------- |
| VOO    | Vanguard S&P 500 ETF                | Equity, U.S., Large Cap          |
